 ...
 * 
 * If the incoming URL contains a 'special' prefix it will be removed from the URL and passed to the
 ...
 * 
 * The opposite is applied to outgoing URL's. If the Mode environmental is present, a prefix will be
 * added to the normal URL generated by tapestry.
 */
