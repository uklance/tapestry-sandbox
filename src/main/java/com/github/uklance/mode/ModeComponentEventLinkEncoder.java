 ...
 * 
 * Looks at incoming URL's for a 'special' prefix. If the incoming URL contains a 'special' prefix
 * it will be removed from the URL and passed to the normal tapestry request processing. The special
 * prefix will be pushed onto the environment stack which can be used by components and pages.
 * 
 * The opposite is applied to outgoing URL's. If the environmental is present, it will be added as a prefix
 * to the normal URL generated by tapestry.
 */
